...
public class GameSettings {
    ...
    public KeyCode getMoveRightKey() { return moveRightKey; }
    public void setMoveRightKey(KeyCode key) { 
        this.moveRightKey = key; 
        saveSettings();
    }
    
    public KeyCode getMoveDownKey() { return moveDownKey; }
    public void setMoveDownKey(KeyCode key) { 
        this.moveDownKey = key; 
        saveSettings();
    }
    
    public KeyCode getRotateKey() { return rotateKey; }
    public void setRotateKey(KeyCode key) { 
        this.rotateKey = key; 
        saveSettings();
    }
    
    public KeyCode getHardDropKey() { return hardDropKey; }
    ...
    public double getTextSizeMultiplier() { return textSizeMultiplier; }
    ...
    public ColorblindMode getColorblindMode() { return colorblindMode; }
